    ...
    return (
      ...
      >
        Full Bio
          ...
          {/* Projects Section */}
          <section id="projects" className="font-body bg-white w-full max-w-4xl mx-auto p-6 rounded-lg shadow-lg mt-10 mb-32">
      ...
      src={`${baseUrl}/images/welfareabroad.png`}                alt="Welfare Abroad"
                ...
                <p className="text-gray-600">
                  I have used Typescript, Next.js, Tailwind CSS, Vercel and Hygraph for this project.
                </p>
              </a>
          ...
          {/* Contact Section */}
          <section id="contact" className="font-body bg-customLightGray w-full max-w-4xl mx-auto p-6 rounded-lg shadow-lg mt-10 mb-32"> {/* Added more bottom margin */}
